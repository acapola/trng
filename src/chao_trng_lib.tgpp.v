``
proc chao_trng_module { name WIDTH NSRC SRC_WIDTH OVERSAMPLING } {
...
chaoentsrc #(.RNG_WIDTH(SRC_WIDTH)) u`$i`_rnd_src (.i_reset(i_reset), .i_clk(i_clk), .i_en(1'b1), .o_rnd(o_sampled[`$i`*SRC_WIDTH+:SRC_WIDTH]));
``}``
